...
import com.plugapp.controller.ControllerPowerMode;
import com.plugapp.controller.ControllerStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new ControllerPowerMode(MainActivity.this).start(switchButton.isChecked() ? switchButton.getTextOn().toString() : switchButton.getTextOff().toString());
